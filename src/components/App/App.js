...
render(){
    ...
    return <AppInner  token={this.state.token} props={this.props}onClickSignout = { this.handleClickSignOut  }  user={this.props.user}  authenticated={this.props.authenticated} />
