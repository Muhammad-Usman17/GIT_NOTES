  ...
  <Card>
          ...
          <ListItem key={index} role={undefined} dense button>
            <ExpansionPanel className="NoteList-Expansion-Panel">
              ...
              <Button
                ...
                className={classStyle}
                onClick={() => {
                  openUpdateDailog(value.filename, value.content);
                }}
              >
                Update Note
              </Button>
    ...
    >
      <DialogTitle id="form-dialog-title">
        {state.orignalFileName}
      </DialogTitle>
      <DialogContent>
        <TextField
          onChange={handleChangeDailogName}
          margin="dense"
          id="dialogName"
          label="Note Name"
          type="email"
        ...
        />
        <TextField
          onChange={handleChangeDailogContent}
          autoFocus
          margin="Note Content"
          id="dialogContent"
          label="Note Content"
      ...
      <DialogActions>
        ...
        <Button
          onClick={() => {
            onUpdateNote(state.orignalFileName);
          }}
          color="primary"
        >
          {' '}Update
